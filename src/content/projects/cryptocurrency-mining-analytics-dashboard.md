...
description: >-
  A real-time analytics pipeline for cryptocurrency mining operations using
  Prometheus, Grafana, and custom exporters to monitor GPU performance metrics
  and mining pool statistics. The system correlates power consumption,
  hashrates, and earnings data across distributed hosts to optimize mining
  efficiency and profitability.
image: '@assets/projects/cryptocurrency-mining-analytics-dashboard/image.png'
...
skills:
  ...
  - Grafana
  - Docker
sourceLink: https://github.com/AlexPerrin/crypto-mining-dashboard
---
...
![System Diagram](/src/assets/projects/cryptocurrency-mining-analytics-dashboard/crypto-mining-dashboard-system-diagram.png)
...
![Prometheus Targets](/src/assets/projects/cryptocurrency-mining-analytics-dashboard/crypto-mining-dashboard-prometheus-targets.png)
...
![Prometheus Query](/src/assets/projects/cryptocurrency-mining-analytics-dashboard/crypto-mining-dashboard-prometheus-query.png)
...
![Grafana Dashboard](/src/assets/projects/cryptocurrency-mining-analytics-dashboard/crypto-mining-dashboard-grafana.png)
