---
title: Google Maps Location History Visualization
description: >-
  Exported and visualized 8 years of GPS location data (1.5M+ coordinates) from
  Google Timeline, preprocessing to filter stationary points while preserving
  daily routes. Implemented GraphHopper routing API to generate accurate
  road-based paths, then merged 1000+ daily files with additive blending to
  create a heat map of frequently traveled areas.
image: '@assets/projects/google-maps-location-history-visualization/image.png'
...
skills:
  ...
  - pandas
  - GIS
sourceLink: https://github.com/AlexPerrin/Google-Maps-Location-History-Visualization
---
...
![](/src/assets/projects/google-maps-location-history-visualization/U01oMR6.png)
...
![](/src/assets/projects/google-maps-location-history-visualization/Z4mEyEp.png)Our data is a series of points with a longitude, latitude, and timestamp. For me there was about 1,500,000+ points along Eastern Ontario from Toronto to Montreal, with most of the points being in my hometown Kingston.
...
![Capture1](/src/assets/projects/google-maps-location-history-visualization/wnn12DS.png)

We can see the map of Kingston, our location history, a boundary I created to include only the points within.

![](/src/assets/projects/google-maps-location-history-visualization/X980dwB.png)
...
![Capture5](/src/assets/projects/google-maps-location-history-visualization/ycWDW7W.pngG)
...
![](/src/assets/projects/google-maps-location-history-visualization/KTFL1ZG.png)While this did clean up the map a little, the resulting lines were almost identical to the previously generated mess.
...
![](/src/assets/projects/google-maps-location-history-visualization/OsTd2hx.png)
...
![](/src/assets/projects/google-maps-location-history-visualization/8qdtM6s.png)
...
![capture11](/src/assets/projects/google-maps-location-history-visualization/q3KWy86.png)

The resulting feature overlayed on our map of Kingston layer looks like this.

![](/src/assets/projects/google-maps-location-history-visualization/pLlOSaQ.png)
...
![](/src/assets/projects/google-maps-location-history-visualization/DweeyAZ.png)

A full resolution image [here](/src/assets/projects/google-maps-location-history-visualization/DweeyAZ.png)
