---
title: Elliptic Curve ElGamal Encryption Implementation
description: >-
  A Python implementation of ElGamal public-key encryption using elliptic curve
  cryptography, featuring custom finite field arithmetic, point operations, and
  support for SEC 2 standardized curves (secp160k1-secp256k1). The
  implementation demonstrates advanced mathematical programming with proper
  object-oriented design for cryptographic key generation and elliptic curve
  group operations.
image: '@assets/projects/elliptic-curve-el-gamal-encryption-implementation/image.png'
...
skills:
  ...
  - 'Signatures '
sourceLink: >-
  https://github.com/AlexPerrin/School-Assignments/tree/master/ELEC%20473%3A%20Cryptography%20and%20Network%20Security
---
